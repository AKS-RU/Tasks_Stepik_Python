...
#
# конструктор __init__, принимающий список записей, в нем могут находиться любые значения. Необходимо сохранить его
# в защищенном атрибуте ._notes
#
...
class Notebook:
    ...
    @property
    def notes_list(self):
        [print(f'{n}.{i}') for n, i in enumerate(self._notes, 1)]
