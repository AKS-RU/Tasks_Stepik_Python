...
#
# метод __init__, принимающий один обязательный аргумент — текст виджета, который необходимо сохранить в атрибут text.
# Также в метод  может поступать произвольное количество именованных аргументов, которые необходимо сохранить в атрибуты
# экземпляра под теми же названиями;
#
# метод config, который принимает произвольное количество именованных аргументов и создает атрибуты экземпляра с
