...
#
# Внутри класса DictMixin вы можете создавать сколько угодно служебных методов и атрибутов, которые помогут вам
# справиться с задачей. Главное, это реализовать метод to_dict(), он является точкой входа для взаимодействия с
# вашим миксином и он должен вернуть представление вашего объекта в виде словаря. Обратите внимание на
# ложенность атрибутов.
import json
...
class DictMixin:
    ...
    def to_dict(self):
        res = json.dumps(self, default=vars)
