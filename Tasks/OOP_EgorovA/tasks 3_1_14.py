...
# Вот что нашкодил Василий, посмотрите реализацию кода ниже. Он не проходит проверки, которые написаны ниже определения
# класса Person. Ваша задача найти ошибки в коде и их исправить
#
# Sample Input:
#
# Sample Output:
