...
#
# Ваша задача создать словарь, в котором пара ключ-значение берется из значений списков, стоящих на одинаковых
# индексах. В качестве ответа выведите полученный словарь
#
# Sample Input:
#
# Sample Output:
