# В этой задаче вам предстоит достать определенные данные из словаря data. Он уже будет определен и
# заполнен данными, поэтому никакого ввода значений в этой программе делать не нужно, просто обращаетесь
# к переменной data
#
