...
# просто нужно сформировать словарь указанной структуры. Повторюсь, выводить на экран ничего не нужно
...
for i in range(len(persons)):
    x = {persons[i][0]: {'salary': persons[i][1], 'gender': persons[i][2], 'passport': persons[i][3]}}
    d.update(x)
# print(d)
