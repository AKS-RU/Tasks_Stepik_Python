...
#
# Входные данные
# В первой строке записана непустая строка, состоящая только из строчных букв латинского алфавита — имя
# пользователя. Эта строка состоит из не более чем 100 букв.
#
# Выходные данные
