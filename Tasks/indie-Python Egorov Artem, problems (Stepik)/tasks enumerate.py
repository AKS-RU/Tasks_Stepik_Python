...
#
# Ваша задача на основании создать список кортежей words_with_position, каждый элемент-кортеж должен
# содержать два значения: само слово и его порядковый номер в списке words
#
...
print(words_with_position:=[(value, index) for index, value in enumerate(words,1)])
